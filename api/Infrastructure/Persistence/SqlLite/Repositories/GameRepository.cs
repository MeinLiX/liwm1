...
public class GameRepository : IGameRepository
{
    ...
    public async Task<Game?> GetGameWithPlayerAsync(AppUser player) => null /*await this.dataContext.Games.LastOrDefaultAsync(g => g.Players.Contains(player) && g.State != GameState.Finished)*/;
